...
public class RobotAction2Block extends TranslatorBlock {



	public RobotAction2Block(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
